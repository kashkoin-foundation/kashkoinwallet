...
const QString BITCOIN_IPC_PREFIX("kashkoin:");

static QString ipcServerName()
{
    QString name("Kashkoin");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start kashkoin: click-to-pay handler");
    else
...
{
    // clicking on kashkoin: URLs creates FileOpen events on the Mac:
